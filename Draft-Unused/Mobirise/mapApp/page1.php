...
?>
    ...
    <head>
        ...
        <style>
            ...
            .sidestyle{
                align-content: center; float: left; width :20%;  height:90%; margin-left: 1%;padding: 10px; margin-bottom: 1%; background-color: #edece4; background-image: url('https://www.transparenttextures.com/patterns/blizzard.png');color: white; border: 1px solid #ccc; border: 1px solid rgba(0, 0, 0, 0.2);
            }
            
            
            .mapappstyle{
                  height:90%; float:left; width: 57%; background-color:silver; padding: 10px; margin-right: 1%;  margin-left: 1%; margin-bottom: 1%; align-content: center;
            }
    ...
    <body>
            ...
            <div class="hamburger">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                        <li class="nav-item dropdown"><a class="nav-link link dropdown-toggle text-white display-4" href="../page3.html#slider1-s" data-toggle="dropdown-submenu" aria-expanded="false">
                        Did you know</a>
                            <div class="dropdown-menu">
                                <div class="dropdown"><a class="dropdown-item text-white dropdown-toggle display-4" href="../page3.html#content4-1g" data-toggle="dropdown-submenu" aria-expanded="false">Infographics</a>
                                    <div class="dropdown-menu dropdown-submenu"><a class="dropdown-item text-white display-4" href="../page3.html#slider1-s">New child care subsidy</a><a class="dropdown-item text-white display-4" href="../page3.html#slider1-s">Tips for choosing a childcare</a><a class="dropdown-item text-white display-4" href="../page3.html#slider1-s">National quality standard frame</a></div>
                                </div><a class="dropdown-item text-white display-4" href="../page3.html#timeline2-t">How can I enroll my kid into a child care<br></a><a class="dropdown-item text-white display-4" href="../page4.html#info2-z">Average fee for suburbs in VIC<br></a></div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-white display-4" href="../page1.html">
                                <font face="MobiriseIcons"><span style="font-size: 25.6px;">&nbsp; &nbsp; &nbsp;</span></font> Find a child care &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a>
                        </li>
                        <li class="nav-item"><a class="nav-link link text-white display-4" href="/Mobirise/page2.html">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; About Us &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a></li>
                        <li class="nav-item"><a class="nav-link link text-white display-4" href="/Mobirise/page1.html"></a></li>
                    </ul>
        ...
        <section style="height : 100%; padding-top: 8%;">
            ...
            <div id="sidebar" class="sidestyle">
                ...
                <br>
                <input name="city" id="childcare" style="margin-top: 0px;" class="controls" type="text" placeholder="Search ">
                ...
                <button id="suburbPlace" style="float:right; cursor:pointer;" title="Check for your current suburb" onclick="goToMyLocation(map);"></button>
            ...
            <div id="map" class="mapappstyle"></div>
                ...
                var writeList = function() {
                    ...
                    if (document.getElementById("list") != null) {
                        ...
                        while (clusMarkers[count] != null) {
                            ...
                            document.getElementById('list').innerHTML += "<u href=# class='listTitle'  onclick='getNameReactive(" + '"' + clusMarkers[count].name + '"' + ")'> " + '' + clusMarkers[count].name + '' + "</a>";
                            ...
                            document.getElementById('list').innerHTML += "<button type='button' class='listButton2' onclick='compareListpush(" + '"' + clusMarkers[count].serviceCode + '"' + ")'> Add to list</button>";

                            document.getElementById('list').innerHTML += "<button type='button' class='listButton3' onclick='calculateAndDisplayRoute(clusMarkers[ " + '"' + count + '"' + "])'> Reroute</button></p>";
                            ...
                            return function() {
                                ...
                                $(document).ready(function() {
                                    if ($('#' + location.ServiceApprovalNumber).length) {
                                        ...
                                        target.parentNode.scrollTop = target.offsetTop - 150;
