...
?>
    ...
    <body>
        ...
        <section style="height : 300%; padding-top: 20%;">



            <div id="sidebar" style="align-content: center; float: left; width :100%;  height: 30%; margin-left: 1%;padding: 10px; margin-bottom: 1%; background-color: #edece4; background-image: url('https://www.transparenttextures.com/patterns/blizzard.png');color: white; border: 1px solid #ccc; border: 1px solid rgba(0, 0, 0, 0.2);">
            ...
            <div id="map" style="  height:30%; float:left; width: 100%; background-color:silver; padding: 10px; margin-right: 1%;  margin-left: 1%; margin-bottom: 1%; align-content: center"></div>
            ...
            <script>
                ...
                function redirect(service) {
                    ...
                    window.open("https://helpinghandsmelbourne.azurewebsites.net/Draft/surajVERSION/hhtest2/DataFromDatabase/index.php?pm=" + service, '_blank');
                ...
                function compare() {
                    ...
                    window.open("https://helpinghandsmelbourne.azurewebsites.net/Draft/surajVERSION/hhtest2/mapApp/compare.php?pm=" + compareList, '_blank');
                    ...
                    markers = locations.map(function(location, i) {
                        ...
                        google.maps.event.addListener(marker, 'click', (function(marker, i) {
                            return function() {
                                ...
                                //console.log(pk);
                                infowindowM.setContent('<a href = "/Draft/surajVERSION/hhtest2/DataFromDatabase/index.php?pm=' + pk + '" target = "_blank"><div>' +
