...
<script type=”text/javascript”>
    if(device.mobile()){
    console.log("123");
    window.location = 'https://helpinghandsmelbourne.azurewebsites.net/Draft/Yiheng/IE%20Project/mapApp/page2.php';
    }
</script>
    ...
    <body>
            ...
            <div class="hamburger">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                        ...
                        <li class="nav-item"><a class="nav-link link text-white display-4" href="page1.html"></a></li>
                    </ul>
        ...
        <section class="map1 cid-qR8TV7EJrt" style="height : 100%; padding-top: 8%;" id="map1-w">
            ...
            <div id="sidebar" style="align-content: center; float: left; width :20%;  height:90%; margin-left: 1%;padding: 10px; margin-bottom: 1%; background-color: #edece4; background-image: url('https://www.transparenttextures.com/patterns/blizzard.png');color: white; border: 1px solid #ccc; border: 1px solid rgba(0, 0, 0, 0.2);">
                ...
                <br>
                <input name="city" id="childcare" style="margin-top: 0px;" class="tt-query" type="text" placeholder="Search ">
                ...
                var writeList = function() {
                    ...
                    if (document.getElementById("list") != null) {
                        ...
                        while (clusMarkers[count] != null) {
                            ...
                            document.getElementById('list').innerHTML += "<button type='button' class='listButton1' onclick='redirect(" + '"' + clusMarkers[count].serviceCode + '"' + ")' > Show more</button>";
                            document.getElementById('list').innerHTML += "<button type='button' class='listButton2' onclick='compareListpush(" + '"' + clusMarkers[count].serviceCode + '"' + ")'> Compare</button></p>";
                            document.getElementById('list').innerHTML += '<hr></hr>';
                            count++;
                        }
                    }
