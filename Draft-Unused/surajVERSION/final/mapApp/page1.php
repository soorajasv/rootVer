...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
                var e1 = document.getElementById("suburbPlace");
                var c1 = document.getElementById("childcare");
                c1.removeAttribute("style");
                c1.style.width = e1.width;
...
<body>
    ...
    <section style="height : 100%; padding-top: 8%;">
        ...
        <div id="sidebar" style="align-content: center; float: left; width :20%;  height:92%; margin-left: 1%;padding: 10px; margin-bottom: 1%; background-color: #edece4; background-image: url('https://www.transparenttextures.com/patterns/blizzard.png');color: white; border: 1px solid #ccc; border: 1px solid rgba(0, 0, 0, 0.2);">
            ...
            <br>
            <input name="city" id="childcare"   style="margin-top: 0px;" type="text" placeholder="Childcare name">
        ...
        <script>
            ...
            $('#childcare').removeAttr("style");
            //console.log(c1.offsetWidth);
                ...
                c1.removeAttribute("city");
            
                console.log(c1.offsetWidth);
                c1.style.width = e1.offsetWidth;
                console.log(c1.offsetWidth);

                console.log(e1.offsetWidth);
            ...
            function compare() {
                ...
                window.open("https://helpinghandsmelbourne.azurewebsites.net/Draft-Unused/surajVERSION/final/mapApp/compare.php?pm=" + compareList, '_blank');
